...
import com.andzilla.smarttune.adapters.FavoriteSongsRecyclerAdapter;
import com.andzilla.smarttune.adapters.SongsRecyclerAdapter;

public class FavoriteSongFragment extends Fragment {

    private static FavoriteSongFragment INSTANCE;
    private SwipeRefreshLayout swipeRefreshLayout;
    private FavoriteSongsRecyclerAdapter adapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FavoriteSongsRecyclerAdapter() {
            @Override
