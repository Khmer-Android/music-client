...
import com.andzilla.smarttune.database.dao.PlayListDAO;
 ...
 */
public class FavoriteSongsRecyclerAdapter extends RecyclerView.Adapter<FavoriteSongsRecyclerAdapter.BaseViewHolder> {

    private String TAG = FavoriteSongsRecyclerAdapter.class.getSimpleName();
    ...
    public FavoriteSongsRecyclerAdapter() {
